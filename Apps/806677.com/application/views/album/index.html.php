...
<div class="container fluid">
	<div id="main">
    	<div id="breadcrumb">
            ...
            <div class="info"><a href="/">首页</a>&nbsp;&nbsp;→&nbsp;&nbsp;<h1 class="title" title="专辑列表">专辑列表</h1></div>
        </div>
		...
		foreach ($list as $k=>$video)
		{
		?>
    	<li><a href="/album/x_<?=String::idCrypt($video->id)?>.html"><?=$video->title?></a><span><?=date('Y-m-d H:i', $video->create_time)?></span></li>
		<?php } ?>
		</ul>
